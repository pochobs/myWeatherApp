var api = "077d02d85c31c97f079531207d3c367a"
$(document).ready(function() {
    ...
    function getUVIndex(lat, lon) {
      fetch("http://api.openweathermap.org/data/2.5/uvi?appid=d91f911bcf2c0f925fb6535547a5ddc9&units=imperial" + lat + "&lon=" + lon)
        .then(function(response) {
          return response.json()
          .then(function(data) {
